...
class Downloader {
                ...
                this.toBuffer(item)
                    ...
                    if (buffer.length) {
                        ...
                        if (zip) {
                            ...
                            await (0, bluebird_1.fromCallback)(cback => (0, fs_1.writeFile)(`${saveDestination}/${item.id}.mp4`, buffer, cback));
                        }
                    }
                    else {
    ...
    async downloadSingleVideo(post) {
        ...
        await (0, bluebird_1.fromCallback)(cb => (0, fs_1.writeFile)(`${this.filepath}/${post.id}.mp4`, result, cb));
    }
}
